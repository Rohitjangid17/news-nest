...
const News = (props) => {
    ...
    const updateNews = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=a5367a3977184e6c8acd72cc1d15c8bb&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
